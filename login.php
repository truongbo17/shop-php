                ...
                <div class="col-md-6 col-md-offset-3">
                    <div class="block text-center">
                        <section class="form login">
                            <h2 class="text-center">ĐĂNG NHẬP NGƯỜI DÙNG | TRUONGBO</h2>
                            ...
                            <p class="mt-20">Chưa có tài khoản à ?<a href="signin.php"> Đăng kí</a></p>
                            <p class="mt-20">Quên mật khẩu hả ?<a href="reset-pass.php"> Lấy lại mật khẩu</a></p>
