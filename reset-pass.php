...
<head>
  ...
  ================================================== -->
    <meta charset="utf-8">
    <title>LOGIN | USER TRUONGBO</title>
                ...
                <div class="col-md-6 col-md-offset-3">
                    <div class="block text-center">
                        <section class="form login">
                            <h2 class="text-center">LẤY LẠI MẬT KHẨU | TRUONGBO</h2>
                            ...
                            <p class="mt-20">Nhớ mật khẩu rồi à ?<a href="login.php"> Trở lại đăng nhập</a></p>
                ...
                if (xhr.readyState === XMLHttpRequest.DONE) {
                    if (xhr.status === 200) {
                        ...
                        if (data === "success") {
                            ...
                            errorText.textContent = "Đường liên kết đặt lại mật khẩu đã được gửi đi,vui lòng kiểm tra Email !";
